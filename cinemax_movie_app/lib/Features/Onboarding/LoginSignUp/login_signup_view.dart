      ...
      body: Column(
        ...
        children: [
          Padding(
            ...
            child: SvgPicture.asset('Assets/images/Logo.svg',height:88 ,width: 88,),
          ),
          Text("CINEMAX",style: GoogleFonts.montserrat( color: ConstColors.whiteColor,fontSize: 28,fontWeight: FontWeight.bold),)
        ,
              Padding(
                padding: const EdgeInsets.only(top: 8,bottom: 4),
                child: Text("Enter your registered ",
                    style: GoogleFonts.montserrat( color: ConstColors.grayColor,fontSize: 14,fontWeight: FontWeight.w600),),
              ),
                  ...
                  Padding(
                    ...
                    child: CustomMainButton(text: "Sign Up",
                  ...
                  ,children: [
                     ...
                     GestureDetector(
                      onTap: () {
                       ...
                       child: Text("Login",
                        style: GoogleFonts.montserrat( color: ConstColors.primaryColor,fontSize: 14,fontWeight: FontWeight.w600),),
                     ),
                ...
                ,  Padding(
                  ...
                  child: Row(
                   ...
                   Container(width: 62,height: 1,color: const Color(0xFF252836),)
                   ,Padding(
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    child: Padding(
                      padding: const EdgeInsets.all(22.0),
                      child: Image.asset('Assets/images/Facebook.png',width: 24,height: 24,),
                    ))
                ],)
